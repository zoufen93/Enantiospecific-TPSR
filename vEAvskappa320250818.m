...
c = 3*10^(8);%m/s
Delta1 = 2*pi*0*10^6; %Hz  Delta1
Delta2 = -(2*pi*50*10^6)/sqrt(2); %Hz  Delta2
Omega1 = 2*pi*50*10^6; %Hz
Omega2 = 2*pi*0.01*10^6; %Hz
kappa1 = 2*pi*10*10^6;
kappa2 = 2*pi*0.1*10^6;
thetacL = pi/2;
thetacR = -pi/2;
theta = thetacL;

% kappa3的范围
kappa3_vals = linspace(0, 1, 301);
...
xlabel('$\kappa^{\prime\prime}/\kappa^{\prime}$','interpreter', 'latex','FontSize',10);%设置x轴标签
...
% 保存到 CSV 文件
data = [xData1' yData3'];
writematrix(data, '/Users/zoufen/Desktop/vEAvskappa3.csv');
