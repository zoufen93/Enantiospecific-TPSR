...
%预分配数组
PL = zeros(length(dthetaf_vals), 1);
PR = zeros(length(dthetaf_vals), 1);
...
% 绘图
subplot(1,1,1)
h1 = plot(dthetaf_vals, ee(:), 'r-', 'DisplayName', 'P4L');
...
saveas(gcf, '/Users/zoufen/Desktop/vEPTvsdthetaf.pdf')
...
% 保存到 CSV 文件
data = [xData1' yData1'];
writematrix(data, '/Users/zoufen/Desktop/vEPTvsdthetaf.csv');
