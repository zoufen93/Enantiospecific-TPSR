...
% 初始化数据表
AL = zeros(length(domega1_vals), 1);
AR = zeros(length(domega1_vals), 1);
...
for i = 1:length(domega1_vals)
    Delta1  = Delta1p - 2*pi*10^(6)*domega1_vals(i);
...
% 绘图
subplot(2,1,1)
h1 = plot(domega1_vals, AL(:), 'r-', 'DisplayName', 'AL');
...
subplot(2,1,2)
h2 = plot(domega1_vals, AR(:), 'b-', 'DisplayName', 'AR');
...
saveas(gcf, '/Users/zoufen/Desktop/Avsdomega1.pdf')
...
writematrix(data, '/Users/zoufen/Desktop/Avsdomega1.csv');
