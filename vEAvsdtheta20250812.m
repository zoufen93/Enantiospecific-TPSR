...
% 初始化数据表
AL = zeros(length(dtheta_vals), 1);
AR = zeros(length(dtheta_vals), 1);
...
subplot(2,1,1)
h1= plot(dtheta_vals, AL(:), 'r-');
hold on;
h2= plot(dtheta_vals, AR(:), 'b--');
hold off;
...
saveas(gcf, '/Users/zoufen/Desktop/vEAvsdtheta.pdf')
...
% 保存到 CSV 文件
data = [xData1' yData3'];
writematrix(data, '/Users/zoufen/Desktop/vEAvsdtheta.csv');
